...
namespace jg.Editor.Library.Property
{
    ...
    public class PropertyManage : StackPanel
    {
        ...
        public delegate void setStateSize();
        public event setStateSize setStateSizeHander = null;
        ...
        Expander
            ...
            expanderShape = new Expander() { Tag = AssetProperty.Shape },
            expanderTpage = new Expander() { Tag = AssetProperty.TPageGroup },
            expanderWordWaterMake = new Expander() { Tag = AssetProperty.WordWaterMake },
               expanderImageWaterMake = new Expander() { Tag = AssetProperty.ImageWaterMake }
            ;
        ...
        public ControlPropertyImageWaterMake cpimageWaterMake = new ControlPropertyImageWaterMake();
        public ControlPropertyWordWaterMake cpiwordWaterMake = new ControlPropertyWordWaterMake();
        public PropertyShapeRect csr = new PropertyShapeRect();
        public PropertyManage()
        {
            ...
            expanderImageWaterMake.Content = cpimageWaterMake;
            expanderWordWaterMake.Content = cpiwordWaterMake;
            ...
            expanderShape.Header = FindResource("FF000094").ToString();
            expanderWordWaterMake.Header = FindResource("FF000092").ToString();
            expanderImageWaterMake.Header = FindResource("FF000093").ToString();
            ...
            expanderWordWaterMake.Margin = new Thickness(0, 1, 0, 0);
            expanderImageWaterMake.Margin = new Thickness(0, 1, 0, 0);
            expanderShape.Margin = new Thickness(0, 1, 0, 0);
            ...
            expanderWordWaterMake.Visibility = System.Windows.Visibility.Collapsed;
            expanderImageWaterMake.Visibility = System.Windows.Visibility.Collapsed;
            expanderShape.Visibility = System.Windows.Visibility.Collapsed;
            ...
            Children.Add(expanderWordWaterMake);
            Children.Add(expanderImageWaterMake);
            Children.Add(expanderShape);
        }
        ...
        public List<DesignerItem> Source
        {
            ...
            set
            {
                value.ForEach(delegate(DesignerItem item)
                {
                    ...
                    cpiwordWaterMake.Source = item;
                    cpimageWaterMake.Source = item;
                    csr.Source = item;
