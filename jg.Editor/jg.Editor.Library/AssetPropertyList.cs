...
namespace jg.Editor.Library
{
    public class AssetPropertyList : Dictionary<AssetType, List<AssetProperty>>
    {
        public AssetPropertyList()
        {
            ...
            Add(AssetType.Animation, new List<AssetProperty>() { AssetProperty.Location, AssetProperty.Action });
            Add(AssetType.Model3D, new List<AssetProperty>() { AssetProperty.Location, AssetProperty.Action });
            Add(AssetType.Shape, new List<AssetProperty>() { AssetProperty.Location, AssetProperty.Transform, AssetProperty.Action, AssetProperty.BackColor ,AssetProperty.Shape});
            Add(AssetType.Topic, new List<AssetProperty>() { AssetProperty.Location, AssetProperty.Transform, AssetProperty.ForeColor, AssetProperty.BackColor, AssetProperty.Action, AssetProperty.Topic });
            Add(AssetType.TopicDrag, new List<AssetProperty>() { AssetProperty.Location, AssetProperty.Transform, AssetProperty.TopicDrag });
