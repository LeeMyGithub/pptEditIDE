...
using jg.HTMLConvert;


namespace jg.HTMLConvert
{
    public static class RichTextboxAssistant
    {
        ...
        public static string GetBoundDocument(DependencyObject dp)
        {
            ...
            if (!string.IsNullOrEmpty(html))
                xaml = jg.HTMLConverter.HtmlToXamlConverter.ConvertHtmlToXaml(html, false);
        ...
        {
            var xaml = value;
            var html = jg.HTMLConverter.HtmlFromXamlConverter.ConvertXamlToHtml(xaml);
