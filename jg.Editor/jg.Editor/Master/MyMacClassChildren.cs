...
namespace jg.Editor
{
     ...
     * 
     */
    public class MyMacClassChildren : Window
    {
        ...
        //    RegistControlWrapper rcw = new RegistControlWrapper((int)hs.Handle);
        //    MessageListener ml = MessageListener.GetInstance();
        //    ml.Regist(rcw);
        //    System.Windows.Forms.Message mes = new System.Windows.Forms.Message();
        //    ml.PreFilterMessage(ref mes);
        //    MessageListener.GlobalKeyDown += MessageListener_GlobalKeyDown;

        //}

        void MessageListener_GlobalKeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            MessageBox.Show("1");
        }
        ...
        //public void SetHookEx()
        //{
        //    try
        //    {
        //        IntPtr hWnd = hs.Handle;
        //        MINI_Client.UI.JG_CPDPM_SystemLog.KeyBordHook keybordhook = new MINI_Client.UI.JG_CPDPM_SystemLog.KeyBordHook(hWnd);
        //    }
        //    catch (Exception ex)
        //    {
        ...
        private void InitializeEvent()
        {
            ...
            {
                //JG_CPDPM.UI.CPDPM_Common.FormHelper.CenterChild(this);
        ...
        public override void OnApplyTemplate()
        {
            ...
            //RestoreButton1 = this.FindVisualChild<Button>(this);
            //maxBtn1 = this.FindVisualChild<Button>(this);
            //if (maxBtn1.Name.ToLower() == "maxBtn")
            //{
            //    maxBtn1.Click += new RoutedEventHandler(this.maxBtn1_Click);
            //}
            //if (RestoreButton1.Name.ToLower() == "RestoreButton")
            //{
            //    RestoreButton1.Click += new RoutedEventHandler(this.RestoreButton1_Click);
            //}

        }

        //void maxBtn1_Click(object sender, RoutedEventArgs e)
        //{
        //    maxBtn1.Visibility = Visibility.Collapsed;
        //    this.WindowState = WindowState.Maximized;
        //    RestoreButton1.Visibility = Visibility.Visible;
        //}

        //void RestoreButton1_Click(object sender, RoutedEventArgs e)
        //{

        //    RestoreButton1.Visibility = Visibility.Collapsed;
        //    this.WindowState = WindowState.Normal;
        //    maxBtn1.Visibility = Visibility.Visible;
        //}
