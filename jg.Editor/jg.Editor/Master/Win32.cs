...
namespace jg.Editor
{
    public static class Win32
    {
        ...
        public const int WM_SYSCOMMAND = 0x022;
        public const int WM_COMMAND = 0x021;
        ...
        [DllImport("user32.dll", CharSet = CharSet.Auto, EntryPoint="SetWindowLong", CallingConvention = CallingConvention.Cdecl)]
        ...
        public const int WM_HSCROLL = 0x24;
        public const int WM_VSCROLL = 0x25;
